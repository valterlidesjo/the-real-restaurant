    ...
    <>
      <div className="w-full flex justify-center items-center flex-col p-8">
        ...
        <div className="flex justity-center items-center w-full">
          <div className="w-[35%] flex justify-evenly items-end flex-col h-32 md:w-[45%]">
          ...
          <div className="w-[65%] flex justify-evenly items-start flex-col h-32 md:w-[55%]">
            <p className="text-[1.35rem] pl-4">+1337 420 420</p>
            <a
              href="mailto:info@terni.kingston?subject=Contact Terni"
